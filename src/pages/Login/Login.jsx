...
const Login = () => {
  return (
    <div
      className="flex justify-center py-10 lg:py-16 bg-cover bg-center"
      style={{
        backgroundImage:
    ...
    >
      <div className="relative flex flex-col text-gray-700 bg-white shadow-md w-96 rounded-xl bg-clip-border">
        ...
        <div className="p-6 pt-0">
          <button
            className="block w-full select-none rounded-lg bg-[#ffb300] py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white"
            type="button"
