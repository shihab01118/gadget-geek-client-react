const NewGaming = () => {
  return (
    <div
      className="min-h-[50vh] md:min-h-[65vh] bg-center bg-cover max-w-6xl mx-8 md:mx-16 lg:mx-auto my-16 lg:my-24 rounded-lg flex items-center"
      style={{
        backgroundImage:
    ...
    >
      <div className="pl-10 lg:pl-40">
        <span className="md:text-lg px-2 py-1 md:px-4 md:py-2 bg-[#ffb300] rounded-md">
          New Gaming
        </span>
        <div className="text-white my-3 md:mt-5 md:mb-8">
          <h1 className="text-4xl md:text-6xl font-black md:mb-4">
            Gamepad-XB1
          </h1>
